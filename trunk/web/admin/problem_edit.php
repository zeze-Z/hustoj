...
<body leftmargin="30" >
  <div id="main" class="container">
    ...
    <form method=POST action=problem_edit.php>
      ...
      <div id="programming_extra_fields" <?php if($row['problem_type'] != 'programming') echo 'style="display:none;"'?>>
      <p align=left>
...
<script>
  ...
  // 题型/选项/答案变更时同步预览
  $(document).on("change keyup input","#problem_type, #options_container, #answer_container",function(){ sync(); }); 
</script>
    <?php
    }
    else {
