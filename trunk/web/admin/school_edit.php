...
<div class="padding">
    <form action="school_edit.php?id=<?php echo $school_id ?>" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" value="<?php echo $school_id ?>" disabled>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="name" class="form-control" value="<?php echo htmlentities($row['name'], ENT_QUOTES, 'UTF-8') ?>" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="code" class="form-control" value="<?php echo htmlentities($row['code'], ENT_QUOTES, 'UTF-8') ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <label>
                    <input type="checkbox" name="status" value="1" <?php echo $row['status'] == 1 ? 'checked' : '' ?>> <?php echo $MSG_ENABLED ?>
                </label>
            </div>
        </div>
