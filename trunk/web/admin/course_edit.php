...
<div class="padding">
    <form action="course_edit.php?id=<?php echo $course_id ?>" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="number" name="preview_price" class="form-control" value="<?php echo intval($row['preview_price'] ?? 0) ?>" min="0" step="1">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="number" name="source_price" class="form-control" value="<?php echo intval($row['source_price'] ?? 0) ?>" min="0" step="1">
                <small class="text-muted">0表示免费；大于0表示需消耗对应积分，1积分=1元</small>
            </div>
        </div>
