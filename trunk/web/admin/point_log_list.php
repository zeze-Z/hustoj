...
$valid_types = [POINT_LOG_TYPE_CARD, POINT_LOG_TYPE_COURSE, POINT_LOG_TYPE_ADMIN, POINT_LOG_TYPE_SYSTEM, POINT_LOG_TYPE_GOODS, POINT_LOG_TYPE_TIMETABLE_QRFREE, POINT_LOG_TYPE_SHARE_REWARD];
