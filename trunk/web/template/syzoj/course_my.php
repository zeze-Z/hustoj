      ...
      <?php foreach ($view_og_orders as $og_index => $og_order): ?>
        ...
        <div class="ui segment" style="border-radius: 0; margin-bottom: 0;">
          <div class="ui grid">
            <div class="row">
              <div class="twelve wide column">
                <h3 style="margin: 0 0 10px 0; color: #333; font-family: Consolas, Monaco, 'Courier New', monospace; font-size: 1em; word-break: break-all;">
                  <?php echo htmlentities($og_order['order_no'], ENT_QUOTES, 'UTF-8'); ?>
                </h3>
                <div style="color: #666; font-size: 0.9em;">
...
<div class="ogd-mask" id="ogd-mask">
    <div class="ogd-modal" role="dialog" aria-modal="true" aria-labelledby="ogd-title">
        ...
        <div class="ogd-body">
            ...
            <!-- 下载按钮 -->
            <a class="ogd-download" href="https://pan.baidu.com/s/1-UdKyErT22pWEs7PFAs4Ag?pwd=ykp6" target="_blank" rel="noopener">⬇️ 离线包下载</a>
