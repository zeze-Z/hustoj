        ...
        <?php else: ?>
          ...
          ?>
            <tr>
              ...
              <td>
                <?php if ($is_course && !empty($log['co_license_type'])): ?>
                  <?php $lt = isset($license_map[$log['co_license_type']]) ? $license_map[$log['co_license_type']] : '未知'; ?>
                  <span class="ui tiny label" style="<?php echo $log['co_license_type'] == 1 ? 'background:#667eea;color:#fff;' : 'background:#52c41a;color:#fff;'; ?>">
