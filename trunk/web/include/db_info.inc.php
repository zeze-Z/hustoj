...
// 支付宝电脑网站支付配置（需要填写实际值）
static $ALIPAY_APP_ID = '2021006143698198';           // 支付宝应用ID
...
static $ALIPAY_GATEWAY_URL = 'https://openapi.alipay.com/gateway.do';  // 正式环境网关，沙箱环境使用 https://openapi-sandbox.dl.alipaydev.com/gateway.do
